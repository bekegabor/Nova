...
@Data
@Scope("session")
@Component(value = "employeeProfileController")
@ELBeanName(value = "employeeProfileController")
@Join(path = "/employee/profile", to = "/employeeprofile/employeeprofile.xhtml")
public class EmployeeProfileController {
    ...
    @Autowired
    public EmployeeProfileController(UserService userService, RegistrationValidationService registrationValidationService){
